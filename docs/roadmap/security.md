...
- [ ] Disable shell history while adding fly secrets if necessary & if possible remove from clipboard.
- [ ] Ensure that server build does DCE on environment variables
